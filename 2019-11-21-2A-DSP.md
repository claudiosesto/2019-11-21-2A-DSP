...
```
Faust è un programma che permette di fare dei calcoli seriali e permette di prendere appunti attraverso il doppio slash. Permette anche di costruire un mixer all'interno del programma
```
